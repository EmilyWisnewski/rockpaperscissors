...
function game(x) {
    ...
    document.getElementById(playerChoice).style.transform = "scale(1.4)";
    ...
    document.getElementById("opponentChoice").src = "img/" + opponentChoice + ".svg";

    //Sets the dimensions of the opponent's choice image if it is rock or paper
    if ((opponentChoice == "rock") || (opponentChoice == "paper")) {
    ...
    document.getElementById(result + "Label").style.textShadow = "0 0 5em var(--fire3)";
    document.getElementById(result + "Number").style.textShadow = "0 0 5em var(--fire3)";
    if (result == "win") {
